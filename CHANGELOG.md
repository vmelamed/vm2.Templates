...
## v3.3.6-preview.4 - 2026-06-22

### Internal

- diff-shared

## v3.3.6-preview.3 - 2026-06-22
...
- update vm2.TestUtilities version to 2.1.1
...
## v3.0.1-preview.1 - 2026-05-29

### Internal

- promote to stable v3.0.0 [skip ci]
- update changelog for v3.0.0 [skip ci]
- update vm2.TestUtilities to Version 2.0.1
...
- set property `IsProductProject` for template projects too
...
- update vm2.TestUtilities to v2.0.1
